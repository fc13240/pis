package ideaStreet.controller.util;
...
public class FileOption {
	...
	public static void userFileOption(int userId,MultipartFile multipartFile,String saveDir,HttpServletResponse response,String saveUrl){
		saveDir+=userId+"/";
		saveUrl+=userId+"/";
		String filename=multipartFile.getOriginalFilename();
		String savePath=saveDir + filename;
	...
	public static String uploaffile(int userId,MultipartFile multipartFile,String saveDir,String saveUrl){
		saveDir+=userId+"/";
		saveUrl+=userId+"/";
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
		String ymd = sdf.format(new Date());
