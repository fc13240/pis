...
<html>
<head>
<title>商标-商标注册包过服务 </title>
<meta name="keywords" content="商标-商标注册包过服务" />
<meta name="description" content="商标-商标注册包过服务" />
...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 商标注册>商标注册包过服务</div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/registration_3.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">商标注册包过服务</span> 
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >商标注册包过服务(1500元)</span>
		    		</a>
      ...
      <tr style="border-top:1px dashed #ececec">
        <td>价&nbsp;&nbsp;格：<span style="color:red;font-size:20px;">1500</span>
      </tr>
      <tr >
        <td height="15"></span>
      </tr>
  ...
  <div class="left-sec">
    <div class="content-top1">
      <ul>
        ...
        <li><a href="javascript:void(0);">常见问题</a><i
            class="arrow arrowT"></i></li>
        <li class="title"><a href="#">&uarr;&nbsp;商标注册包过服务</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
    <div class="list-item dashed-line J_minTop">
      ...
      <div class="list-item-main">
        <p>商标查询（2天内）→申请文件准备（3天内）→提交申请（2天内）→缴纳商            标注册费用→商标形式审查（3个月）→下发商标受理通知书→商标实质审查（12个月）→商标公告（3个月）→颁发商标证书(商品全部驳回，退全款，若是部分驳回，查看客户主要类别，若主要类别未驳回，则不退，若主要类别商标被驳，退款1500）</p>
      </div>      
 	</div>
    <div class="list-item">
      <h3>所需材料</h3>
