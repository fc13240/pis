...
<html>
<head>
<title>商标-商标注册包过服务+设计logo+版权登记 </title>
<meta name="keywords" content="商标-商标注册包过服务+设计logo+版权登记" />
<meta name="description" content="商标-商标注册包过服务+设计logo+版权登记" />
...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 商标注册>商标注册包过服务+设计logo+版权登记</div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/registration_4.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">商标注册包过服务+设计logo+版权登记</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >服务介绍：商标是用来区别一个经营者的品牌或服务和其他经营者的商品或服务的标记，由文字、图形、字母、数字、三维标志、声音、颜色组合，或上述要素的组合，具有显著特征的标志。商标核准注册之后10年之内不需要缴纳任何费用，每隔10年续展一次。</div>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >商标注册包过服务+设计logo+版权登记(3500元)</span>
		    		</a>
      ...
      <tr style="border-top:1px dashed #ececec">
        <td>价&nbsp;&nbsp;格：<span style="color:red;font-size:20px;">3500</span>
      </tr>
      <tr >
        <td height="15"></span>
      </tr>
...
<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2850130082&site=qq&menu=yes"><img src="http://r.lotut.com/Themes/Home/default/Public/image/zx_qq.gif" border="0" style="" href="http://wpa.qq.com/pa?p=2:2850130082:51" alt="与客服小产进行交谈" title="与客服小产进行交谈"/></a>
</div> 
         <div style="float:left;margin-left:15px;">王维娜：</div>
<div style="float:left;">
<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3001150423&site=qq&menu=yes"><img src="http://r.lotut.com/Themes/Home/default/Public/image/zx_qq.gif" border="0" href="http://wpa.qq.com/pa?p=2:3001150423:51" alt="与客服小王进行交谈" title="与客服小王进行交谈"/></a>
</div>
      </tr>
    </table>
  </div>
  ...
  <div class="left-sec">
    <div class="content-top1">
      <ul>
       ...
       <li><a href="javascript:void(0);">常见问题</a><i
            class="arrow arrowT"></i></li>
             -->
        <li class="title"><a href="#">&uarr;&nbsp;商标注册包过服务+设计logo+版权登记</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
    <div class="list-item dashed-line J_minTop">
      ...
      <div class="list-item-main">
        <p>商标：商标查询（2天内）→申请文件准备（3天内）→提交申请（2天内）→缴纳商            标注册费用→商标形式审查（3个月）→下发商标受理通知书→商标实质</p>
     	<p>审查：（12个月）→商标公告（3个月）→颁发商标证书(商品全部驳回，退全款，若是部分驳回，查看客户主要类别，若主要类别未驳回，则不退，若主要类别商标被驳，退款3500）</p>
       	<p>版权登记：提交作品—版权委托书—提交（营业执照复印件、身份证复印件）—交费—受理—审查—证书（三十个工作日）</p>
      </div>      
 	</div>
    <div class="list-item">
      <h3>所需材料</h3>
      <div class="list-item-main">
      	<p>商标：</p>
        <p>1、自然人申请需出示您身份证及递交个体工商户、个人合伙等经营主体的营业执照复印件等。</p>
        <p>2、企业申请需出示企业盖公章的营业执照副本。盖有单位公章及个人签字的填写完整的商标注册申请书等。</p>
      	<p>3、委托书盖公章或签字扫描件。</p>
     	<p>4、商标图样10张(指定颜色的彩色商标，应交着色图样10张，黑白墨稿1张)。</p>   
      	<p>版权：</p>
        <p>1、准备作品说明书（作品文档、作品载体）</p>
        <p>2、作品著作权登记申请表格</p>
      	<p>3、作品登记申请书</p>
     	<p>4、营业执照副本复印件1份（单位申请），自然人（个人）申请需提供身份证复印件1份（加盖公章或签字）</p> 
     	<p>5、委托书盖章，一份（我们提供格式）</p>  
     	<p>6、登记作品复印件、权利归属证明（或协议书）、权利保证书</p> 
     	<p>7、美术作品登记应提交155*115（mm）作品复印件一式二份。</p>    	     
      </div>
    ...
    <div class="list-item">
      ...
      <div class="list-item-main">
        <p>1. 我是自然人可以申请商标吗?</p>
        <p>虽然商标法第四条规定，自然人、法人和其他组织是可以申请商标的，但是在我国纯自然人是不能申请商标的。法律规定从事生产、制造、加工、拣选、经销商品或者提供服务的自然人是可以申请的，具体的是由商标局出具的文件进行了限定。一般来说申请商标的主体是公司或者个体工商户。</p>
      	<p>2. 自己设计的文字或图像能申请注册商标吗?</p>
      	<p>商标法规定任何能够将自然人、法人或者其他组织的商品与他人的商品区别开的标志，包括文字、图形、字母、数字、三维标志、颜色组合和声音等，以及上述要素的组合，均可以作为商标申请注册。</p>
      	<p>3. 注册一个商标可以在所有商品上都使用吗?</p>
      	<p>并不是注册一个商标就在所有的商品或者服务上都获得保护的。我们国家将商品或者服务分成45大类，其分类标准是《类似商品和服务区分类表》。在商标申请的时候我们就必须选择相应的商品或者服务。所以在申请注册商标的时候，应该选择自己正在使用的或者将来准备使用的商品或者服务类别进行注 册。</p>
      	<p>4. 申请商标需要多长时间?</p>
      	<p>3个月左右下受理，6-8个月网上可以查询到，10-12个月出公告，13-15个月异议期，无人异议，给预核准。</p>
        <p>5. 申请商标能100%成功吗?</p>
      	<p>任何人申请商标都是有风险的，不能保证一定成功，但会根据相关的审查标准判断相应的概率于委托人，以便委托人决定是否注册。</p>   	
      </div>
