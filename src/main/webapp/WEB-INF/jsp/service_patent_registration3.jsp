...
<html>
<head>
<title>专利申请-外观设计 </title>
<meta name="keywords" content="专利申请-外观设计" />
<meta name="description" content="专利申请-外观设计" />
...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 专利申请>外观设计</div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/patent_3.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">外观设计</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >简介：外观设计是指对产品的形状、图案或其结合以及色彩与形状、图案的结合所作出的富有美感并适于工业应用的新设计，外观设计保护产品的外观，要求具有：新颖性。
 			</div>
     	
        	<div class="box_2" style="display:none;">简介：在线撰写（免费）保护产品外形、包装等，3-6个月授权，
10年保护期需提供设计效果图或各面正投影照片，产品名称与用途。线上自助服务代理费用300，需提供处理好的外观设计图片或照片，
各面视图尺寸必须对应，必要时提供参考视图，产品名称与用途。
			</div>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >线上服务(400元)</span>
		    		</a>
					<a href="javascript:;"  data="2" class="s-class">
						<span val="tr_reg_3" >在线撰写(免费)</span>
					</a>															
				</div>
	...
	$("."+box_id).show().siblings().hide();
      ...
      <tr style="border-top:1px dashed #ececec">
        <td>价&nbsp;&nbsp;格：<span style="color:red;font-size:20px;">
        	<div class="box_1" >400</div>
        	<div class="box_2" style="display:none;">免费</div>
      ...
      <tr style="">
        ...
        <div style="float:left;margin-left:15px;">  黄亚男：</div>
<div style="float:left;">
<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2850130088&site=qq&menu=yes"><img src="http://r.lotut.com/Themes/Home/default/Public/image/zx_qq.gif" border="0" style="" href="http://wpa.qq.com/pa?p=2:2850130088:51" alt="与客服亚男进行交谈" title="与客服亚男进行交谈"/></a>
</div> 
         <div style="float:left;margin-left:15px;">王静静：</div>
<div style="float:left;">
<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3001130997&site=qq&menu=yes"><img src="http://r.lotut.com/Themes/Home/default/Public/image/zx_qq.gif" border="0" href="http://wpa.qq.com/pa?p=2:3001130997:51" alt="与客服静静进行交谈" title="与客服静静进行交谈"/></a>
</div>
      </tr>
    </table>
  </div>
    ...
    <div class="content-top1">
      <ul>
        ...
        <li><a href="javascript:void(0);">所需材料</a><i
            class="arrow arrowT"></i></li>
        <li><a href="javascript:void(0);">官费</a><i
            class="arrow arrowT"></i></li>
        <li><a href="javascript:void(0);">免费撰写教程</a><i
            class="arrow arrowT"></i></li>            
        <li class="title"><a href="#">&uarr;&nbsp;外观设计</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
    <div class="list-item dashed-line J_minTop">
    <h3>代理机构：专利由合肥市科融知识产权代理事务所代理</h3><br>
      <h3>办理流程</h3>
      <div class="list-item-main">
      	...
      	<div class="box_3">
      		<p>在线撰写---分享给龙图腾工作人员----付费---代理人修改---客户确认--提交申请--授权缴费--领取证书</p>
      	</div>
...
<table>
    ...
    <div class="list-item">
      <h3>免费撰写教程</h3>
      <div class="list-item-main">
        <p>1、访问网址 http://g.lotut.com，注册然后登陆<br></p>
        <p>
        <img src="<s:url value='/images/zaixian_01.png'/>">
        <br>
        </p>
    	<p>2、选择专利撰写导航栏<br></p>
         <p>
        <img src="<s:url value='/images/zaixian_02.png'/>">
        <br>
        </p>   	
    	<p>3、选择专利撰，并选择类别<br></p>
        <p>
        <img src="<s:url value='/images/zaixian_03.png'/>">
        <br>
        </p>    	
    	<p>4、开始撰写专利<br></p>
        <p>
        <img src="<s:url value='/images/zaixian_04.png'/>">
        </p>    	
      </div> 
