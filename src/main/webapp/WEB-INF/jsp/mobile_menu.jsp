...
<a class="quick-entry-link fz12 J_ping" report-eventid="MHome_Icons" report-eventparam="主页" page_name="index" href="<s:url value='/mobile/index.html'/>">
		...
		<a class="quick-entry-link fz12 J_ping" report-eventid="MHome_Icons" report-eventparam="专利列表" page_name="index" href="<s:url value='/mobile/index.html'/>">
		...
		<a class="quick-entry-link fz12 J_ping" report-eventid="MHome_Icons" report-eventparam="商标列表" page_name="index" href="<s:url value='/mobile/index.html'/>">
