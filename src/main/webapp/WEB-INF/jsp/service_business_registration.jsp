...
<head>
<title>工商注册 </title>
<meta name="keywords" content="工商注册" />
<meta name="description" content="工商注册" />
...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 工商注册</div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/business.jpg'/>" alt="" title=""></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">工商注册</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >服务介绍：工商注册  免费</div>
        	<div class="box_2" style="display:none;">服务介绍：专属会计，免费工商咨询，龙图腾代账每月188每年1800</div>
        	<!-- 
        	<div class="box_3" style="display:none;">简介：工商注册3简介</div>
        	 -->
        </td>
      </tr>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >工商管理(免费)</span>
		    		</a>
		    		 
					<a href="javascript:;"  data="2" class="s-class">
						<span val="tr_reg_2" >税务管理(188元)</span>
					</a>
					<!--
					<a href="javascript:;"  data="3" class="s-class">
						<span val="tr_reg_3" >工商注册3</span>
					</a>
					 -->
				</div>
	...
	$("."+box_id).show().siblings().hide();
      ...
      <tr style="border-top:1px dashed #ececec">
        <td>价&nbsp;&nbsp;格：<span style="color:red;font-size:20px;">
        	...
        	<div class="box_1" >免费</div>
        	<div class="box_2" style="display:none;">188</div>
      ...
      <tr style="">
        ...
        <div style="float:left;margin-left:15px;">  产俊涛：</div>
<div style="float:left;">
<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2850130082&site=qq&menu=yes"><img src="http://r.lotut.com/Themes/Home/default/Public/image/zx_qq.gif" border="0" style="" href="http://wpa.qq.com/pa?p=2:2850130082:51" alt="与客服小涛进行交谈" title="与客服小涛进行交谈"/></a>
</div> 
         <div style="float:left;margin-left:15px;">周笑林：</div>
<div style="float:left;">
<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2851238685&site=qq&menu=yes"><img src="http://r.lotut.com/Themes/Home/default/Public/image/zx_qq.gif" border="0" href="http://wpa.qq.com/pa?p=2:2851238685:51" alt="与客服小周进行交谈" title="与客服小周进行交谈"/></a>
</div>
      </tr>
    </table>
  </div>
  ...
  <div class="left-sec">
    <div class="content-top1">
      <ul>
        ...
        <li class="on"><a href="javascript:void(0);">业务流程</a><i
            class="arrow arrowT"></i></li>

        <li class="title"><a href="#">&uarr;&nbsp;工商注册</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
    <div class="list-item dashed-line J_minTop">
      ...
      <div class="list-item-main">
        	...
        	<div class="box_1" >
        	<p>1、名称预先核准登记(无重名的话2个工作日)：</p>
        	<p>核名，公司名称的核准是企业成立的开端，也是一个标志。企业名称的组成形式分为行
政区划+公司字号(名称)+行业特点+组织形式。</p>
        	<p>2、网上预约登记(3-5个工作日)：</p>  
        	<p>在合肥市工商局网站上进行企业网上登记，在这里登记的是公司注册的全部信息，包括：
公司名称、注册资本、法人、股东及股东的出资比例、任职分配、注册地址等信息;</p> 
        	<p>3、工商局设立登记所需资料：</p> 
        	<p>⑴《公司登记（备案）申请书》</p> 
        	<p>⑵《指定代表或者共同委托代理人授权委托书》及指定代表或委托代理人的身份证复印件。</p> 
        	<p>⑶全体股东签署的公司章程</p> 
        	<p>⑷股东的主体资格证明或者自然人身份证件复印件</p> 
        	<p>★股东为企业的，提交营业执照复印件</p> 
        	<p>★股东为事业法人的，提交事业法人登记证书复印件</p> 
        	<p>★股东为社团法人的，提交社团法人登记证件复印件</p> 
        	<p>★股东为民办非企业单位的，提交民办非企业单位证书复印件</p> 
        	<p>★股东为自然人的提交身份后只能见复印件</p> 
        	<p>⑸董事、监事、经理以及法人的任职文件（股东会决议由全体股东签署，董事会决议由公司董事签字）</p> 	
        	<p>⑹董事、监事、经理以及法人的身份证件复印件</p> 
        	<p>⑺住所使用证明（租赁合同、房产证复印件）</p> 
        	<p>⑻租赁承诺书</p> 
        	<p>⑼设立登记审核表</p> 
        	<p>⑽企业名称预先核准通知书</p> 
        	<p>4、工商领取营业执照(5个工作日)：</p> 
        	<p>我们按照指定的时间把公司材料交给工商登记人员之后，领取工商受理单，受理单上也
写明5个工作日领取营业执照，所以到时间去取照窗口领取即可;</p> 
        	<p>5、公安局刻章备案(1个工作日)：</p> 
        	<p>领取营业执照之后拿着相关材料到公安局刻章备案单位办理企业刻制印章备案登记，一
般找刻章公司全套办理就可以。如果找我们，您就可以直接给我们来电话，我们会全程为您办理;</p> 
        	<p>6、银行开设基本账户(5-7个工作日)：</p> 
        	<p>选择就近的银行拿着已办理的全套资料及章到就近的银行开设企业的基本账户，当天办理完之后需要等待5-7个工作日领取开户许可证，
目前人民银行附加一个企业的“机构信用代码证”，也是企业的一个重要的证件;</p>         	
        	<p>7、国税、地税的备案及三方协议的签订(2个工作日)。</p>
        	<p>至此，所有新办企业的流程全部结束</p>
        	</div>
        	<div class="box_2" style="display:none;">
        	
        	<p>业务合作流程：<br>联系我们→分配最合适的会计→与会计沟通→签订合同→开始合作</p>
        	
        	<p>代理记账流程：</p>
        	<p>1、每月初，委托方快递方式提供上月所有原始单据。</p>
        	<p>2、我司财务人员用财务软件进行制单、会计人员审核、结转、记账、编制财务报表及纳税申报表。</p>
        	<p>3、每月月初，我司代为进行纳税申报，提交委托方财务报表，并提供合理的财税建议。</p>
        	<p>交接所需资料：</p>
        	<p>1、营业执照副本复印件或扫描件</p>
        	<p>2、开户许可证复印件或扫描件</p>
        	<p>3、国地税及个税申报密码，数字证书方式的需提供CA棒及密码</p>
        	<p>4、所有月份的会计凭证装订入册，完整连续，不得漏缺</p>
        	<p>5、总分类账与明细账（总账金额，与明细账总额要一致）</p>
        	<p>6、各月份资产负债表与利润表（两表要平）</p>
        	<p>7、所有的纳税申报表（增值税、所得税预缴、所得税汇算清缴、地税综合申报表、代扣代缴个人所得税申报表）增值税税率，所得税税率</p>
        	<p>8、所有月份的银行对账单，并查看最后的银行对账单余额与实际银行存款账面余额是否一致（必须一致）</p>
        	<p>9、其他会计账簿及资料</p>
        	<p>正式代账每月所需资料：</p>
        	<p>1、现金单据（差旅费、业务招待费、员工工资、社保费、通讯费、运输费、邮递费等）</p>
        	<p>2、银行单据（提现、转账、电汇、进账单、借款单、银行对账单等）</p>
        	<p>3、发票（上月1日--31日开具的所有发票）</p>
        	<p>4、其他所需资料</p>
