...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 计算机版权 </div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/copyright_registration_2.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">计算机版权</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >服务介绍：计算机软件版权，为主张权利或提出权利纠纷行政处理或诉讼的证明文件，需要提供申请表、软件操作说明书、部分源代码，个人拥有版权保护期权至死后50年，企拥有版权业保护50年。</div>
        </td>
      </tr>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >计算机版权(1200元)</span>
		    		</a>
				</div>				
        </td>
      </tr>      
...
<div class="container">
  <div class="left-sec">
    <div class="content-top1">
      <ul>
        ...
        <li><a href="javascript:void(0);">常见问题</a><i
            class="arrow arrowT"></i></li>
        <li class="title"><a href="#">&uarr;&nbsp;计算机版权</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
     <div class="list-item dashed-line J_minTop">
      ...
      <div class="list-item-main">
        <p>填写申请表--→提交申请文件--→缴纳申请费--→中国版权保护中心受理--→补正申请文件（非必须程序）--→取得《软件著作权登记证书》</p>
      </div>
    </div>
    ...
    <div class="list-item">
      <h3>所需材料</h3>
      <div class="list-item-main">
        <p>1.加盖公章的《计算机软件著作权申请表》一份。由咨询机构提供，填写内容由咨询机构协助申请企业填写。</p>
        <p>2.加盖企业公章的营业执照副本复印件一份或个人身份证复印件扫描件。</p>
        <p>3.软件源程序一份。一般按照源程序的前30页和后30页提供，而且源程序的作者应该是著作权人，源程序中的日期须在开发完成日期之前，源程序当中的名称必须与申请表中全称或简称保持一致。</p>
        <p>4.操作手册、用户手册、使用说明书、设计说明书等等，任选其中一种。文档中的日期应在软件开发完成的日期之前，文档中若有图片出现，须提供使用该图片的证明材料即可。</p>                              
      </div>
    ...
    <div class="list-item">
      <h3>常见问题 </h3>
      <div class="list-item-main">
        <p>1、我想办理软件著作权登记业务，但是又担心我的软件代码因此泄露，怎么办？</p>
      	<p>一般来讲，申请人在计算机软件著作权登记申请过程中提交的源代码、程序文档等材料是被严格保密的，除非经过公检法等部门的依法查 询，除申请人以外的其他人都无法接触到申请人提交的材料。《计算机软件著作权登记办法》中规定，“软件著作权登记时，申请人可以申请将源程序、文档或者样 品进行封存。除申请人或者司法机关外，任何人不得启封”。另外，目前登记机关允许申请人对软件代码进行特殊处理后再提交，这种提交方式被称为“例外交存”。目前允许的例外交存方式主要有如下几种情况 ： A 对鉴别材料作例外交存：（一）源程序的前、后各连续的3０页，其中的机密部分用黑色宽斜线覆盖，但覆盖部分不得超过交存源程序的5０％；（二）源程序连续的前１０页，加上源程序的任何部分的连续的５０页；（三）目标程序的前、后各连续的3０页，加上源程序的任何部分的连续的２０页。 B 对程序文档的例外交存文档作例外交存的，参照前款规定处理。</p>
      </div>
    </div>
  </div>
