...
<meta name="description" content="商标注册" />
...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 商标注册</div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/shangbiao.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">商标注册</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >简介：商标俗称品牌，是品牌在法律保护层面的概念。商标的主要目的是区别不同商品/服务来源，让消费者能够认牌选购。 注册商标是将您的商标在商标局进行注册，以获得在本地区（大陆）内独家使用该商标标识的权利。注册商标是产品/服务上市销售的第一步，就像出生的婴儿需要上户口一样， 没有注册商标，您的产品/服务在印制包装、广告宣传、进驻商场、电商平台、开通微信公众号等活动中都将处处受阻，所以如果您的产品/服务已经计划面市了，就赶快为它起个名字注册吧！</div>
        	<div class="box_2" style="display:none;">简介：商标俗称品牌，是品牌在法律保护层面的概念。商标的主要目的是区别不同商品/服务来源，让消费者能够认牌选购。 注册商标是将您的商标在商标局进行注册，以获得在本地区（大陆）内独家使用该商标标识的权利。注册商标是产品/服务上市销售的第一步，就像出生的婴儿需要上户口一样， 没有注册商标，您的产品/服务在印制包装、广告宣传、进驻商场、电商平台、开通微信公众号等活动中都将处处受阻，所以如果您的产品/服务已经计划面市了，就赶快为它起个名字注册吧！</div>
        	
        	<div class="box_3" style="display:none;">简介：商标俗称品牌，是品牌在法律保护层面的概念。商标的主要目的是区别不同商品/服务来源，让消费者能够认牌选购。 注册商标是将您的商标在商标局进行注册，以获得在本地区（大陆）内独家使用该商标标识的权利。注册商标是产品/服务上市销售的第一步，就像出生的婴儿需要上户口一样， 没有注册商标，您的产品/服务在印制包装、广告宣传、进驻商场、电商平台、开通微信公众号等活动中都将处处受阻，所以如果您的产品/服务已经计划面市了，就赶快为它起个名字注册吧！</div>
			<div class="box_4" style="display:none;">简介：商标俗称品牌，是品牌在法律保护层面的概念。商标的主要目的是区别不同商品/服务来源，让消费者能够认牌选购。 注册商标是将您的商标在商标局进行注册，以获得在本地区（大陆）内独家使用该商标标识的权利。注册商标是产品/服务上市销售的第一步，就像出生的婴儿需要上户口一样， 没有注册商标，您的产品/服务在印制包装、广告宣传、进驻商场、电商平台、开通微信公众号等活动中都将处处受阻，所以如果您的产品/服务已经计划面市了，就赶快为它起个名字注册吧！</div>
			<div class="box_5" style="display:none;">简介：商标俗称品牌，是品牌在法律保护层面的概念。商标的主要目的是区别不同商品/服务来源，让消费者能够认牌选购。 注册商标是将您的商标在商标局进行注册，以获得在本地区（大陆）内独家使用该商标标识的权利。注册商标是产品/服务上市销售的第一步，就像出生的婴儿需要上户口一样， 没有注册商标，您的产品/服务在印制包装、广告宣传、进驻商场、电商平台、开通微信公众号等活动中都将处处受阻，所以如果您的产品/服务已经计划面市了，就赶快为它起个名字注册吧！</div>
			<div class="box_6" style="display:none;">简介：商标俗称品牌，是品牌在法律保护层面的概念。商标的主要目的是区别不同商品/服务来源，让消费者能够认牌选购。 注册商标是将您的商标在商标局进行注册，以获得在本地区（大陆）内独家使用该商标标识的权利。注册商标是产品/服务上市销售的第一步，就像出生的婴儿需要上户口一样， 没有注册商标，您的产品/服务在印制包装、广告宣传、进驻商场、电商平台、开通微信公众号等活动中都将处处受阻，所以如果您的产品/服务已经计划面市了，就赶快为它起个名字注册吧！</div>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >国内普通商标注册</span>
		    		</a>
					<a href="javascript:;"  data="2" class="s-class">
						<span val="tr_reg_2" >集体商标注册</span>
					</a>
					<a href="javascript:;"  data="3" class="s-class">
						<span val="tr_reg_3" >证明商标注册</span>
					</a>
					<a href="javascript:;"  data="3" class="s-class">
						<span val="tr_reg_4" >补发商标注册证申请</span>
					</a>
					<a href="javascript:;"  data="3" class="s-class">
						<span val="tr_reg_5" >出具商标注册证明申请</span>
					</a>
					<a href="javascript:;"  data="3" class="s-class">
						<span val="tr_reg_6" >更正商标申请</span>
					</a>															
				</div>
...
$('.s-new-01 a').bind('click', function(){
	...
	$("."+box_id).show().siblings().hide();
      ...
      <tr style="border-top:1px dashed #ececec">
        <td>价&nbsp;&nbsp;格：<span style="color:red;font-size:20px;">800</span>
      </tr>
      <tr >
        <td height="15"></span>
      </tr>
      <tr style="">
        ...
        <div style="float:left;margin-left:15px;">  林小三：</div>
<div style="float:left;">
<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2850130083&site=qq&menu=yes"><img src="http://r.lotut.com/Themes/Home/default/Public/image/zx_qq.gif" border="0" style="" href="http://wpa.qq.com/pa?p=2:2850130083:51" alt="与客服小林进行交谈" title="与客服小林进行交谈"/></a>
</div> 
         <div style="float:left;margin-left:15px;">代丽曼：</div>
<div style="float:left;">
  ...
  <div class="left-sec">
    <div class="content-top1">
      <ul>
        ...
        <li class="on"><a href="javascript:void(0);">服务介绍</a><i
            class="arrow arrowT"></i></li>
        <li><a href="javascript:void(0);">办理流程</a><i
            class="arrow arrowT"></i></li>
        <li><a href="javascript:void(0);">所需材料</a><i
            class="arrow arrowT"></i></li>
        <li><a href="javascript:void(0);">常见问题</a><i
            class="arrow arrowT"></i></li>
        <li class="title"><a href="#">&uarr;&nbsp;商标注册</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
