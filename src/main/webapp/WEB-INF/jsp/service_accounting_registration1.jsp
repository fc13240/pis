...
<head>
<title>代账会计 </title>
<meta name="keywords" content="代账会计" />
<meta name="description" content="代账会计" />
...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 代账会计</div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/daizhang.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">代账会计</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >简介：龙图腾代账，每月188元，每年1800元；一对一沟通，一流的团队，数字化科学管理，专业督查，贴心服务，让您放心省心！</div>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >代账会计</span>
		    		</a>
					<!-- <a href="javascript:;"  data="2" class="s-class">
						<span val="tr_reg_2" >代账会计2</span>
					</a>
					<a href="javascript:;"  data="3" class="s-class">
						<span val="tr_reg_3" >代账会计3</span>
					</a>-->
				</div>
...
$('.s-new-01 a').bind('click', function(){
	...
	$("."+box_id).show().siblings().hide();
      ...
      <tr style="border-top:1px dashed #ececec">
        <td>价&nbsp;&nbsp;格：<span style="color:red;font-size:20px;">188</span>
      </tr>
      <tr >
        <td height="15"></span>
      </tr>
