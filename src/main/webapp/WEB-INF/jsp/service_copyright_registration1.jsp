...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 普通版权 </div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/copyright_registration_1.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">普通版权</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >服务介绍：版权登记证明文件是登记事项的一种初步证明，为主张权利或提出权利纠纷行政处理或诉讼的证明文件，主要体现为文字、美术、摄影、电影、音乐、建筑作品及工程设计图等。个人拥有版权保护期权至死后50年，企拥有版权业保护50年。</div>
        </td>
      </tr>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >普通版权(600元)</span>
		    		</a>
				</div>				
        </td>
      </tr>      
      <tr style="border-top:1px dashed #ececec">
        <td>价&nbsp;&nbsp;格：<span style="color:red;font-size:20px;">600</span>
      </tr>
      <tr >
        <td height="15"></span>
      </tr>
...
<div style="float:left;">
<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2850130089&site=qq&menu=yes"><img src="http://r.lotut.com/Themes/Home/default/Public/image/zx_qq.gif" border="0" href="http://wpa.qq.com/pa?p=2:2850130089:51" alt="与客服静静进行交谈" title="与客服静静进行交谈"/></a>
</div>
      </tr>
    </table>
  </div>
  ...
  <div class="left-sec">
    <div class="content-top1">
      <ul>
        ...
        <li><a href="javascript:void(0);">常见问题</a><i
            class="arrow arrowT"></i></li>
        <li class="title"><a href="#">&uarr;&nbsp;普通版权</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
     <div class="list-item dashed-line J_minTop">
      ...
      <div class="list-item-main">
        <p>提交作品——版权委托书——提交（营业执照复印件、身份证复印件）——交费——受理——审查——证书（三十个工作日 ）</p>
      </div>
    </div>
    ...
    <div class="list-item">
      ...
      <div class="list-item-main">
        ...
        <p>4.权利保证书</p>
        <p>5.作品创作说明书</p> 
        <p>6.法人作品：(1).营业执照复印件（A4） (2).法定代表人身份证复印件（A4）</p>
        <p>法人单位：身份证复印件（A4）</p>                                
      </div>
    ...
    <div class="list-item">
      ...
      <div class="list-item-main">
        <p>1.哪些作品可申请登记?</p>
        <p>我国著作权法第三条规定的各类作品均可申请登记。包括：文字作品；口述作品；音乐、戏剧、曲艺、舞蹈、杂技艺术作品；美术、建筑作品；摄影作品；电影作品和以类似摄制电影的方法创作的作品；工程设计图、产品设计图、地图、示意图等图形作品和模型作品；计算机软件；法律、行政法规规定的其它作品。</p>
      	<p>2.为什么要进行作品著作权登记？</p>
      	<p> (1)确定作品的版权归属，登记证书可以作为权利人的初步证据；</p> 
        <p> (2)公信力强，有效预防纠纷发生;  </p>
        <p> (3)为权利人在发生纠纷时主张权利提供有力的证据； </p>
        <p> (4)协助司法机方便、快捷地取证； </p>
        <p> (5)有利于权利人更有效管理和使用作品；   </p>
        <p> (6)登记证书是许可使用和转让版权的重要凭证；</p>
      	<p>3.哪些作品不能申请登记？</p>
      	<p>(1)依法禁止出版、传播的作品；</p>
      	<p>(2)法律、法规、国家机关的决议、决定、命令和其他具有立法、行政、司法性质的文件，及其官方正式译文；</p>
      	<p>(3)时事新闻；</p>
      	<p>(4)历法、通用数表、通用表格和公式；</p>
      	<p>(5)超过保护期限的作品。</p>
      </div>
