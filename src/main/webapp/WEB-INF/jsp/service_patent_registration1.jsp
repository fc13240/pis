...
<html>
<head>
<title>专利申请-发明专利 </title>
<meta name="keywords" content="专利申请-发明专利" />
<meta name="description" content="专利申请-发明专利" />
...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 专利申请>发明专利</div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/patent_1.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">发明专利</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >简介：发明专利是指对产品、方法或者其改进所提出的新的技术方案，保护时间20年，从申请日起算，授权之后每年缴纳年费，发明专利保护产品、方法或者两者结合，要求具有：新颖性、创造性、实用性。</div>
        	<div class="box_2" style="display:none;">简介：在线撰写（免费）</div>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >专利代理(1900元)</span>
		    		</a>
    ...
    <div class="content-top1">
      <ul>
        ...
        <li><a href="javascript:void(0);">免费撰写教程</a><i
            class="arrow arrowT"></i></li> 
        <li class="title"><a href="#">&uarr;&nbsp;发明专利</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
