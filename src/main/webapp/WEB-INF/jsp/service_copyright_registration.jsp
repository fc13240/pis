...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 版权登记 </div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/banquan.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">版权登记</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >简介：美术作品，是指绘画、书法、雕塑等以线条、色彩或者其他方式构成的有审美意义的平面或者立体的造型艺术作品；</div>
        	<div class="box_2" style="display:none;">简介：文字作品，是指小说、诗词、散文、论文等以文字形式表现的作品；</div>
        	<div class="box_3" style="display:none;">简介：软件著作权是指软件的开发者或者其他权利人依据有关著作权法律的规定，对于软件作品所享有的各项专有权利。就权利的性质而言，它属于一种民事权利，具备民事权利的共同特征。</div>
        </td>
      </tr>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >美术著作权</span>
		    		</a>
					<a href="javascript:;"  data="2" class="s-class">
						<span val="tr_reg_2" >文字著作权</span>
					</a>
					<a href="javascript:;"  data="3" class="s-class">
						<span val="tr_reg_3" >软件著作权</span>
					</a>
				</div>
    ...
    <div class="content-top1">
      <ul>
        ...
        <li><a href="javascript:void(0);">常见问题</a><i
            class="arrow arrowT"></i></li>
        <li class="title"><a href="#">&uarr;&nbsp;代账会计</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
