...
<html>
<head>
<title>专利申请-实用专利 </title>
<meta name="keywords" content="专利申请-实用专利" />
<meta name="description" content="专利申请-实用专利" />
...
<!--当前位置-->
<div class="container">
  <div class="current-location"> <a href="/">首页</a> > 专利申请>实用专利</div>
</div>
<!--当前位置 end--> 
  ...
  <div class="left-sec">
    <div class="flexslider">
      <div class="picBtnLeft">
        <div class="bd">
          <ul>
            <li><a href="#"><img src="<s:url value='/images/patent_2.jpg'/>" ></a></li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td>
       <span style="line-height: 44px;font-size:20px;collor:#000000;">实用专利</span> 
      ...
      <tr>
        <td>
        	<div class="box_1" >简介：实用新型是指对产品的形状、构造或者其结合所提出的适于实用的新的技术方案，保护时间10年，从申请日起算，授权之后每年缴纳年费，实用新型保护产品结构，要求具有：新颖性、创造性、实用性。
			</div>
        	<div class="box_2" style="display:none;">简介：在线撰写（免费）。
保护产品型状、构造等微创新，3-6个月授权，10年保护期需提供技术介绍说明文件及CAD图纸。线上自助
服务代理费用500，需提供处理好的符合申请格式的撰写文稿。
			</div>
        ...
        <td width="250px;">
				<div class="s-new-01" id="s-new-01">
		    		<a href="javascript:;"  data="1" class="s-class s-hover">
		    			<span val="tr_reg_1" >专利代理(900元)</span>
		    		</a>
					<a href="javascript:;"  data="2" class="s-class">
						<span val="tr_reg_2" >在线撰写(免费)</span>
					</a>															
				</div>
  ...
  <div class="left-sec">
    <div class="content-top1">
      <ul>
        ...
        <li class="title"><a href="#">&uarr;&nbsp;实用专利</a><i
            class="arrow arrowT"></i></li>
      </ul>
    </div>
